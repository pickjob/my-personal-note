...
if has("unix")
    set runtimepath+=~/repository/vimfiles
    call plug#begin('~/repository/vimfiles/plugged')
elseif has("win32")
    set runtimepath+=C:/repository/vimfiles
    call plug#begin('C:/repository/vimfiles/plugged')
endif
